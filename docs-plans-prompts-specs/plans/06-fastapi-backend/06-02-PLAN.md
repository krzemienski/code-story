...
<context>
@BRIEF.md
@src/codestory/backend/core/security.py
@src/codestory/backend/models/user.py
</context>
...
<task type="auto">
  ...
  <files>src/codestory/backend/api/schemas/auth.py, src/codestory/backend/api/deps.py</files>
  <action>
Create auth schemas:
...
from src.codestory.backend.core.database import get_session
from src.codestory.backend.core.security import decode_jwt_token
from src.codestory.backend.models.user import User
from src.codestory.backend.api.exceptions import UnauthorizedError, ForbiddenError
...
async def get_api_key_user(
    ...
    from src.codestory.backend.models.api_key import APIKey
...
```
  ...
  <verify>python -c "from src.codestory.backend.api.schemas.auth import UserRegister; print('Schemas OK')"</verify>
  <done>Auth schemas and dependencies created</done>
</task>

<task type="auto">
  <n>Task 2: Create auth router</n>
  <files>src/codestory/backend/api/routers/auth.py</files>
  <action>
...
from src.codestory.backend.api.schemas.auth import (
    UserRegister,
    UserLogin,
    TokenResponse,
    TokenRefresh,
...
from src.codestory.backend.api.exceptions import (
    UnauthorizedError,
    ConflictError,
)
from src.codestory.backend.models.user import User
from src.codestory.backend.core.security import (
    hash_password,
    verify_password,
    create_jwt_token,
    decode_jwt_token,
...
```
  ...
  <verify>python -c "from src.codestory.backend.api.routers.auth import router; print('Auth router OK')"</verify>
