...
@src/codestory/mobile/contexts/AuthContext.tsx
</context>
...
<task type="auto">
  ...
  <files>src/codestory/mobile/app/(app)/home.tsx, src/codestory/mobile/app/(app)/_layout.tsx</files>
  <action>
(app)/_layout.tsx:
```tsx
...
<task type="auto">
  ...
  <files>src/codestory/mobile/app/(app)/new.tsx</files>
  <action>
