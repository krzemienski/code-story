...
@src/codestory/mobile/lib/storage.ts
</context>
...
<task type="auto">
  ...
  <files>src/codestory/mobile/contexts/AuthContext.tsx</files>
  <action>
Create auth context:
...
<task type="auto">
  ...
  <files>src/codestory/mobile/app/(auth)/login.tsx, src/codestory/mobile/app/(auth)/register.tsx, src/codestory/mobile/app/(auth)/_layout.tsx</files>
  <action>
(auth)/_layout.tsx:
```tsx
