...
<task type="auto">
  ...
  <files>src/codestory/frontend/package.json, src/codestory/frontend/vite.config.ts, src/codestory/frontend/tsconfig.json</files>
  <action>
...
export default defineConfig({
  ...
  server: {
    ...
    proxy: {
      ...
      // SSE endpoint for real-time progress (from SDK hooks)
      '/api/sse': {
        target: 'http://localhost:8000',
        changeOrigin: true,
      },
...
<task type="auto">
  ...
  <files>src/codestory/frontend/tailwind.config.js, src/codestory/frontend/src/index.css</files>
  <action>
Install Tailwind:

```bash
cd src/codestory/frontend
...
<task type="auto">
  ...
  <files>src/codestory/frontend/src/App.tsx, src/codestory/frontend/src/main.tsx</files>
  <action>
...
│   ├── useAuth.ts
│   ├── useStories.ts
│   └── useSSE.ts     # SSE hook for SDK progress events
├── lib/
│   ├── api.ts        # API client
│   ├── sse.ts        # SSE client for progress
│   └── utils.ts      # Utilities
├── pages/
│   ├── LandingPage.tsx
│   ├── LoginPage.tsx
