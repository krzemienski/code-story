...
<context>
@BRIEF.md
@src/codestory/frontend/src/App.tsx
</context>
...
<task type="auto">
  ...
  <files>src/codestory/frontend/src/lib/api.ts, src/codestory/frontend/src/contexts/AuthContext.tsx</files>
  <action>
Create API client:
...
<task type="auto">
  ...
  <files>src/codestory/frontend/src/pages/LandingPage.tsx, src/codestory/frontend/src/pages/LoginPage.tsx, src/codestory/frontend/src/pages/RegisterPage.tsx</files>
  <action>
Create LandingPage:
